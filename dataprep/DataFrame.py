...
# Change in Prozent (/100) und Angabe in Namen "Change in %"
def dta_preparation():
    ...
    dta_final.to_csv("BrentDataset_prep.csv")
    return dta_final

# Skalierungswerte auslesen beim Transformer
def dta_rescaled(dta_final):
    ...
    dta_final.to_csv("BrentDataset_rescaled.csv")
    return dta_final
